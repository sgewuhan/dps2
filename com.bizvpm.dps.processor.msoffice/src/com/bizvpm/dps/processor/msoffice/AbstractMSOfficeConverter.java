...
public abstract class AbstractMSOfficeConverter {
	...
	public abstract Dispatch openDocument(ActiveXComponent app, String filename)
			throws Exception;

	public abstract void convert(Dispatch dis, String toFilename)
			throws Exception;

	public abstract void dispose(ActiveXComponent app, Dispatch dis)
			throws Exception;

	public static AbstractMSOfficeConverter getInstance(String sourceType)
			throws Exception {
