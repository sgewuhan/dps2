 ...
 *******************************************************************************/
package com.bizvpm.dps.runtime.ui;
 ...
 * </p>
 */
public class StringFieldEditor2 extends FieldEditor {
	 ...
	 * @since 2.0
	 */
	public StringFieldEditor2(String name, String labelText, int width, int strategy, int textStyle, Composite parent) {
		init(name, labelText);
		widthInChars = width;
	 ...
	 *            the parent of the field editor's control
	 */
	public StringFieldEditor2(String name, String labelText, int width, Composite parent) {
		this(name, labelText, width, VALIDATE_ON_KEY_STROKE, SWT.SINGLE | SWT.BORDER, parent);
	}
	 ...
	 *            the parent of the field editor's control
	 */
	public StringFieldEditor2(String name, String labelText, Composite parent) {
	...
	public Text getTextControl(Composite parent) {
		if (textField == null) {
			textField = new Text(parent, textStyle);
