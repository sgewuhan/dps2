 ...
 *       &lt;sequence>
 *         &lt;element name="values" type="{http://server.dps.bizvpm.com/}keyValuePair" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataSet implements IDataSetAdaptable {
	...
	public DataSet append(String field, Object value) {
		KeyValuePair kv = new KeyValuePair();
		kv.setKey(field);
		kv.setValue(new DataObjectConverter().getDataObject(value));
		getValues().add(kv);
		return this;
	}
