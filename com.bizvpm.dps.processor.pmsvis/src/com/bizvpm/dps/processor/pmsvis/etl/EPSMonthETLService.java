...
import com.bizvpm.dps.processor.pmsvis.tools.Formatter;
				...
				.asList(new Document("$addFields", new Document("discountRate", discountRate).append("nowYear", year)
						...
						new Document("$addFields",
								new Document("realityYearAvgProfit", "$salesRealityTotalData.avgProfit")
										...
										.append("realityPresentAvgProfit", "$salesRealityTotalData.presentAvgProfit")
										...
										.append("realityPresentRevenue", "$salesRealityTotalData.presentRevenue")
										.append("realityPresentCost", "$salesRealityTotalData.presentCost")
										.append("realityPresentProfit", "$salesRealityTotalData.presentProfit")
										.append("realityProfitRate", "$salesRealityTotalData.profitRate")
										...
										.append("pipeline", Arrays.asList(
												...
												new Document("$lookup",
														new Document("from", "project").append("localField",
																"cbs.scope_id").append("foreignField",
																		"_id")
																.append("as", "project")),
												new Document("$unwind",
														new Document("path", "$project").append(
																"preserveNullAndEmptyArrays", true)),
												new Document("$addFields", new Document("project_id",
														new Document("$ifNull",
																Arrays.asList("$work.project_id", "$project._id")))),
												new Document("$lookup", new Document("from", "project").append(
														"localField", "project_id").append("foreignField", "_id")
														.append("as", "project")),
												new Document("$unwind", new Document("path", "$project")),
												new Document("$project", new Document("id", true)
														.append("budget", new Document(
						...
						new Document("$addFields",
								new Document("budget", "$cbsTotalData.budget").append("cost", "$cbsTotalData.cost")
						...
						new Document("$unwind", new Document("path", "$salesForecastTotalData")
								.append("preserveNullAndEmptyArrays", true)),
						new Document("$project",
								new Document("eps_id", "$eps_id")
										...
										.append("realityYearAvgProfit",
												new Document("$ifNull", Arrays.asList("$realityYearAvgProfit", 0.0)))
										.append("realityYearPresentAvgProfit",
												new Document("$ifNull",
														Arrays.asList("$realityYearPresentAvgProfit", 0.0)))
										.append("realityPresentAvgProfit",
												new Document("$ifNull", Arrays.asList("&realityPresentAvgProfit", 0.0)))
										...
										.append("realityPresentRevenue",
												new Document("$ifNull", Arrays.asList("$realityPresentRevenue", 0.0)))
										.append("realityPresentCost",
												new Document("$ifNull", Arrays.asList("$realityPresentCost", 0.0)))
										.append("realityPresentProfit",
												new Document("$ifNull", Arrays.asList("$realityPresentProfit", 0.0)))
										.append("realityProfitRate",
												new Document("$ifNull", Arrays.asList("$realityProfitRate", 0.0)))
										.append("realityPresentProfitRate",
												new Document("$ifNull",
						...
						new Document("$group", new Document("_id", "$eps_id")
								.append("forecastYearAvgProfit", new Document("$sum", "$forecastYearAvgProfit"))
								.append("forecastYearPresentAvgProfit",
										new Document("$sum", "$forecastYearPresentAvgProfit"))
								.append("forecastPresentAvgProfit", new Document("$sum", "$forecastPresentAvgProfit"))
								...
								.append("forecastProfitRate", new Document("$sum", "$forecastProfitRate"))
								.append("forecastPresentProfitRate", new Document("$sum", "$forecastPresentProfitRate"))
								.append("realityYearAvgProfit", new Document("$sum", "$realityYearAvgProfit"))
								.append("realityYearPresentAvgProfit",
										new Document("$sum", "$realityYearPresentAvgProfit"))
								.append("realityPresentAvgProfit", new Document("$sum", "$realityPresentAvgProfit"))
								...
								.append("realityProfitRate", new Document("$sum", "$realityProfitRate"))
								.append("realityPresentProfitRate", new Document("$sum", "$realityPresentProfitRate"))
								.append("budget", new Document("$sum", "$budget"))
								.append("cost", new Document("$sum", "$cost"))
								.append("presentBudget", new Document("$sum", "$presentBudget"))
								.append("presentCost", new Document("$sum", "$presentCost"))
