...
public class ProjectMonthETLService extends AbstractMonthETLService {
	...
	private void createProjectMonthData(MongoCollection<Document> prjColl, MongoCollection<Document> pMDCol,
		...
		// 获取项目月绩效数据
		List<Bson> pipeline = Arrays.asList(new Document("$addFields", new Document("discountRate", discountRate)
				.append("nowYear", year).append("sDate", year + month)), new Document("$lookup",
						new Document("from", "salesforecast")
								...
								.append("pipeline", Arrays.asList(
										...
										new Document("$group", new Document("_id", "$GJAHR")
												.append("revenue", new Document("$sum", "$VV010")).append("cost",
														new Document("$sum",
																new Document("$add",
										...
										new Document("$addFields", new Document()
												...
												.append("presentCost",
														new Document("$cond", Arrays.asList(
																new Document("$gte", Arrays.asList("$exponent", 0.0)),
																new Document("$divide", Arrays.asList("$cost",
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs", "$exponent"))))),
																new Document("$multiply", Arrays.asList("$cost",
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																		...
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs", "$exponent"))))),
																new Document("$multiply", Arrays.asList("$profit",
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs",
																						"$exponent"))))))))),
										new Document("$addFields", new Document()
												.append("profitRate", new Document("$cond",
														Arrays.asList(
																new Document("$eq",
				...
				new Document("$lookup", new Document()
						.append("from",
								"cbsSubject")
						.append("let",
								new Document("project_id",
										"$_id").append("discountRate",
						...
						.append("pipeline",
								Arrays.asList(
										...
										new Document("$graphLookup", new Document("from", "cbs").append("startWith",
												"$cbs._id").append("connectFromField", "parent_id").append(
														"connectToField", "_id")
												.append("as", "cbs")),
										new Document("$lookup", new Document("from", "work").append("localField",
												"cbs.scope_id").append("foreignField", "_id").append("as", "work")),
										...
										new Document("$lookup", new Document("from",
												"project")
														.append("localField", "cbs.scope_id").append(
																"foreignField", "_id")
														.append("as", "project")),
										new Document("$unwind", new Document("path", "$project").append(
												"preserveNullAndEmptyArrays", true)),
										new Document("$addFields", new Document("project_id",
												new Document("$ifNull", Arrays.asList(
														"$work.project_id", "$project._id")))),
										new Document("$lookup", new Document("from", "project").append("localField",
												"project_id").append("foreignField", "_id").append("as", "project")),
										...
										new Document("$group", new Document()
												.append("_id", new Document("$substr", Arrays.asList("$id", 0.0, 4.0)))
										...
										new Document("$addFields",
												new Document()
														.append("presentBudget", new Document("$cond", Arrays.asList(
																new Document("$gte", Arrays.asList("$exponent", 0.0)),
																		...
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs", "$exponent"))))))))
														.append("presentCost", new Document("$cond", Arrays.asList(
																new Document("$gte", Arrays.asList("$exponent", 0.0)),
																new Document("$divide", Arrays.asList("$cost",
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
				...
				new Document("$lookup", new Document("from", "salesMonthData")
						.append("let", new Document("project_id", "$_id").append("discountRate", "$discountRate")
								.append("nowYear", "$nowYear").append("sDate", "$sDate"))
						.append("pipeline",
								Arrays.asList(
										new Document("$match",
										...
										new Document("$group", new Document("_id", null)
												...
												.append("cost", new Document("$sum", "$cost"))
												.append("profit", new Document("$sum", "$profit"))
												.append("presentRevenue", new Document("$sum", "$presentRevenue"))
										...
										new Document("$addFields", new Document()
												.append("profitRate", new Document("$cond", Arrays.asList(
														new Document("$eq",
																Arrays.asList(new Document("$ifNull",
																		Arrays.asList("$revenue", 0.0)), 0.0)),
														0.0,
				...
				new Document("$unwind", new Document("path", "$salesRealityTotalData").append(
						"preserveNullAndEmptyArrays", true)),
				new Document("$lookup", new Document("from", "cbsSubject")
						.append("let",
								new Document(
										"project_id", "$_id").append("discountRate", "$discountRate").append("nowYear",
												"$nowYear"))
						.append("pipeline", Arrays.asList(
								new Document("$lookup",
								...
								new Document("$graphLookup",
										new Document("from", "cbs").append("startWith", "$cbs._id")
												.append("connectFromField", "parent_id").append("connectToField", "_id")
												.append("as", "cbs")),
								new Document("$lookup",
										new Document("from", "work").append("localField", "cbs.scope_id")
												.append("foreignField", "_id").append("as", "work")),
								new Document("$unwind",
										new Document("path", "$work").append("preserveNullAndEmptyArrays", true)),
								new Document("$lookup",
										new Document("from", "project").append("localField", "cbs.scope_id")
												.append("foreignField", "_id").append("as", "project")),
								new Document("$unwind",
										new Document("path", "$project").append("preserveNullAndEmptyArrays", true)),
								new Document("$addFields",
										new Document("project_id", new Document("$ifNull",
												Arrays.asList("$work.project_id", "$project._id")))),
								new Document("$lookup",
										new Document("from", "project").append("localField", "project_id")
												.append("foreignField", "_id").append("as", "project")),
								new Document("$unwind", new Document("path", "$project")),
								new Document("$project", new Document("id", true)
										.append("budget", new Document("$ifNull", Arrays.asList("$budget", 0.0)))
										.append("cost", new Document("$ifNull", Arrays.asList("$cost", 0.0)))
										.append("project_id", true)),
								new Document("$match",
										new Document("$expr", new Document("$and", Arrays.asList(
												new Document("$eq", Arrays.asList("$project_id", "$$project_id")))))),
								new Document("$group",
										new Document("_id", new Document("$substr", Arrays.asList("$id", 0.0, 4.0)))
												.append("budget", new Document("$sum", "$budget"))
												.append("cost", new Document("$sum", "$cost"))),
								new Document("$addFields",
										new Document("exponent",
												new Document("$subtract", Arrays.asList(new Document("$toInt", "$_id"),
														new Document("$toInt", "$$nowYear"))))),
								new Document("$addFields", new Document()
										.append("presentBudget", new Document("$cond",
																		...
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs", "$exponent"))))))))
										.append("presentCost", new Document("$cond",
												Arrays.asList(new Document("$gte", Arrays.asList("$exponent", 0.0)),
														new Document("$divide",
																Arrays.asList("$cost",
																		new Document("$pow", Arrays.asList(
																...
																Arrays.asList("$cost",
																		new Document("$pow", Arrays.asList(
																				...
																				new Document("$abs",
																						"$exponent"))))))))),
								new Document("$group",
										new Document("_id", null).append("budget", new Document("$sum", "$budget"))
												.append("cost", new Document("$sum", "$cost"))
												.append("presentBudget", new Document("$sum", "$presentBudget"))
												.append("presentCost", new Document("$sum", "$presentCost")))))
						.append("as", "cbsTotalData")),
				new Document("$unwind", new Document("path", "$cbsTotalData").append("preserveNullAndEmptyArrays",
						true)),
				new Document("$lookup", new Document("from", "salesforecast")
						...
						.append("pipeline", Arrays.asList(
								...
								new Document("$group", new Document("_id", "$GJAHR")
										...
										.append("cost",
												new Document("$sum",
														new Document("$add", Arrays.asList("$VV030", "$VV040"))))
										.append("profit",
												new Document("$sum", new Document("$subtract", Arrays.asList("$VV010",
														new Document("$add", Arrays.asList("$VV030", "$VV040"))))))),
								new Document("$addFields",
										new Document("exponent",
												new Document("$subtract", Arrays.asList(new Document("$toInt", "$_id"),
														new Document("$toInt", "$$nowYear"))))),
								new Document("$addFields", new Document()
										.append("presentRevenue", new Document("$cond",
												Arrays.asList(new Document("$gte", Arrays.asList("$exponent", 0.0)),
														new Document("$divide",
																		...
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs", "$exponent"))))))))
										.append("presentProfit", new Document("$cond",
												Arrays.asList(new Document("$gte", Arrays.asList("$exponent", 0.0)),
														new Document("$divide",
								...
								new Document("$addFields", new Document()
										.append("profitRate",
												new Document("$cond", Arrays.asList(
														...
														0.0,
														new Document("$divide", Arrays.asList("$profit", "$revenue")))))
										.append("presentProfitRate", new Document("$cond", Arrays.asList(
												new Document("$eq",
														Arrays.asList(new Document("$ifNull",
																Arrays.asList("$presentRevenue", 0.0)), 0.0)),
												0.0,
												new Document("$divide",
														Arrays.asList("$presentProfit", "$presentRevenue"))))))))
						.append("as", "salesForecastTotalData")),
				new Document("$unwind", new Document("path", "$salesForecastTotalData").append(
						"preserveNullAndEmptyArrays", true)),
				new Document("$lookup",
				...
				new Document("$unwind", new Document("path", "$salesForecastMonthData").append(
						"preserveNullAndEmptyArrays", true)),
				new Document("$lookup", new Document("from", "salesMonthData")
						.append("let",
								new Document("project_id", "$_id").append("discountRate", "$discountRate")
				...
				new Document("$unwind", new Document("path", "$salesRealityMonthData").append(
						"preserveNullAndEmptyArrays", true)),
				new Document("$lookup", new Document().append("from", "cbsSubject")
						.append("let",
								new Document("project_id", "$_id").append("discountRate", "$discountRate")
										.append("nowYear", "$nowYear"))
						.append("pipeline", Arrays.asList(
				...
				new Document("$unwind", new Document("path", "$cbsMonthData").append("preserveNullAndEmptyArrays",
						true)),
				new Document("$project", new Document("project_id", "$_id").append("pmId", "$pmId")
						.append("forecastYearAvgProfit",
								new Document("$ifNull", Arrays.asList("$salesForecastTotalData.avgProfit", 0.0)))
						.append("forecastYearPresentAvgProfit",
								new Document("$ifNull", Arrays.asList("$salesForecastTotalData.presentAvgProfit", 0.0)))
						...
						.append("forecastPresentRevenue",
								new Document("$ifNull", Arrays.asList("$salesForecastTotalData.presentRevenue", 0.0)))
						.append("forecastPresentCost",
								new Document("$ifNull", Arrays.asList("$salesForecastTotalData.presentCost", 0.0)))
						.append("forecastPresentProfit",
								new Document("$ifNull", Arrays.asList("$salesForecastTotalData.presentProfit", 0.0)))
						.append("forecastProfitRate",
								new Document("$ifNull", Arrays.asList("$salesForecastTotalData.profitRate", 0.0)))
						...
						.append("forecastMonthProfitRate",
								new Document("$ifNull", Arrays.asList("$salesForecastMonthData.profitRate", 0.0)))
						...
						.append("realityYearPresentAvgProfit",
								new Document("$ifNull", Arrays.asList("$salesRealityTotalData.presentAvgProfit", 0.0)))
						...
						.append("realityPresentRevenue",
								new Document("$ifNull", Arrays.asList("$salesRealityTotalData.presentRevenue", 0.0)))
						.append("realityPresentCost",
								new Document("$ifNull", Arrays.asList("$salesRealityTotalData.presentCost", 0.0)))
						.append("realityPresentProfit",
								new Document("$ifNull", Arrays.asList("$salesRealityTotalData.presentProfit", 0.0)))
						.append("realityProfitRate",
								new Document("$ifNull", Arrays.asList("$salesRealityTotalData.profitRate", 0.0)))
						.append("realityPresentProfitRate",
								new Document("$ifNull", Arrays.asList("$salesRealityTotalData.presentProfitRate", 0.0)))
						...
						.append("realitytMonthProfitRate",
								new Document("$ifNull", Arrays.asList("$salesRealityMonthData.profitRate", 0.0)))
						...
						.append("presentCost", new Document("$ifNull", Arrays.asList("$cbsTotalData.presentCost", 0.0)))
						.append("monthBudget", new Document("$ifNull", Arrays.asList("$cbsMonthData.budget", 0.0)))
						.append("monthCost", new Document("$ifNull", Arrays.asList("$cbsMonthData.cost", 0.0)))
						.append("salesForecastYearData", true).append("salesRealityYearData", true).append(
								"cbsYearData", true)),
				new Document("$addFields",
						new Document()
								.append("forecastPP",
										new Document("$cond",
												Arrays.asList(
														new Document(
																"$eq", Arrays.asList("$forecastYearAvgProfit", 0.0)),
														0.0,
														new Document("$multiply",
																Arrays.asList(
																		new Document("$divide",
								...
								.append("realityPP",
										new Document("$cond",
												Arrays.asList(
														new Document(
																"$eq", Arrays.asList("$realityYearAvgProfit", 0.0)),
														0.0,
														new Document("$multiply",
																Arrays.asList(
																		new Document("$divide",
								...
								.append("forecastROI",
										new Document("$cond",
												Arrays.asList(new Document("$eq", Arrays.asList("$budget", 0.0)), 0.0,
														new Document("$divide",
																Arrays.asList("$forecastYearAvgProfit", "$budget")))))
								.append("forecastPresentROI", new Document("$cond",
										Arrays.asList(new Document("$eq", Arrays.asList("$presentBudget", 0.0)), 0.0,
												new Document("$divide",
														Arrays.asList("$forecastYearPresentAvgProfit",
																"$presentBudget")))))
								.append("realityROI",
										new Document("$cond",
												Arrays.asList(new Document("$eq", Arrays.asList("$cost", 0.0)), 0.0,
														new Document("$divide",
																Arrays.asList("$realityYearAvgProfit", "$cost")))))
								.append("realityPresentROI", new Document("$cond",
										Arrays.asList(new Document("$eq", Arrays.asList("$presentCost", 0.0)), 0.0,
												new Document("$divide",
														Arrays.asList("$realityYearPresentAvgProfit",
																"$presentCost")))))
								.append("forecastNPV", new Document("$add",
										Arrays.asList(new Document("$multiply", Arrays.asList(-1.0, "$presentBudget")),
												"$forecastPresentProfit")))
								.append("realityNPV", new Document("$add",
										Arrays.asList(new Document("$multiply", Arrays.asList(-1.0, "$presentCost")),
												"$realityPresentProfit")))
								.append("forecastNPVR", new Document("$cond",
										Arrays.asList(new Document("$eq", Arrays.asList("$presentBudget", 0.0)), 0.0,
												new Document("$divide",
														Arrays.asList(
																new Document("$add",
																		Arrays.asList(
																				...
																				"$forecastPresentProfit")),
																"$presentBudget")))))
								.append("realityNPVR", new Document("$cond",
										Arrays.asList(new Document("$eq", Arrays.asList("$presentCost", 0.0)), 0.0,
												new Document("$divide",
														Arrays.asList(
																new Document("$add",
		...
		prjColl.aggregate(pipeline).allowDiskUse(true).forEach((Document doc) -> {
			...
			doc.append("year", year).append("month", month);
			pMDCol.insertOne(doc);
		});
