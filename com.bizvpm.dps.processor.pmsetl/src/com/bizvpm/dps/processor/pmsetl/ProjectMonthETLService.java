...
public class ProjectMonthETLService extends AbstractMonthETLService {
	...
	private void createProjectMonthData(MongoCollection<Document> prjColl, MongoCollection<Document> pMDCol,
		...
		// 获取项目月绩效数据
		List<Bson> pipeline = Arrays.asList(new Document().append("$addFields", new Document()
				.append("discountRate", discountRate).append("nowYear", year).append("sDate", year + month)),
				new Document().append("$lookup", new Document().append("from", "salesforecast").append("let",
						new Document().append("project_id", "$_id").append("discountRate", "$discountRate").append(
								"nowYear", "$nowYear"))
						.append("pipeline", Arrays.asList(
								new Document().append("$match", new Document().append("$expr", new Document().append(
										"$and",
								...
								new Document().append("$group", new Document().append("_id", "$GJAHR")
										...
										.append("profit", new Document().append("$sum",
												new Document().append("$subtract", Arrays.asList("$VV010",
														new Document().append("$add",
																Arrays.asList("$VV030", "$VV040"))))))),
								new Document().append("$addFields",
										new Document().append("exponent", new Document().append("$subtract",
								...
								new Document().append("$addFields", new Document()
										.append("presentRevenue", new Document().append("$cond", Arrays.asList(
												...
												new Document().append("$divide",
														Arrays.asList("$revenue", new Document().append("$pow",
				...
				new Document()
						.append("$lookup",
								new Document().append("from", "salesMonthData")
										.append("let",
												new Document().append("project_id", "$_id")
										...
										.append("pipeline", Arrays.asList(
												...
												new Document().append("$group", new Document().append("_id", "$GJAHR")
														.append("revenue",
																new Document().append("$sum", "$revenue"))
														.append("cost",
																				...
																				Arrays.asList("$profit", new Document()
																						.append("$pow", Arrays.asList(
																								...
																								new Document().append(
																										...
																										"$exponent"))))))))),
												new Document().append("$addFields", new Document()
														.append("profitRate", new Document().append("$cond",
																Arrays.asList(new Document().append("$eq",
																		Arrays.asList(
				...
				new Document().append("$lookup",
						new Document()
								.append("from", "cbsSubject").append(
										"let",
										new Document()
												.append("project_id", "$_id").append("discountRate",
														"$discountRate")
						...
						.append("$lookup",
								new Document()
										.append("from", "cbsSubject").append(
												"let",
												new Document().append("project_id",
														"$_id").append("discountRate", "$discountRate")
														.append("nowYear", "$nowYear"))
										.append("pipeline", Arrays.asList(new Document().append("$lookup",
												new Document().append("from", "cbs").append("localField",
														"cbsItem_id").append("foreignField", "_id")
														.append("as", "cbs")),
												new Document().append("$unwind", "$cbs"),
												new Document().append(
														"$graphLookup", new Document().append("from", "cbs")
												...
												new Document().append("$unwind",
														new Document().append("path", "$work")
																.append("preserveNullAndEmptyArrays", true)),
												new Document()
														.append("$lookup", new Document().append("from", "project")
																.append("localField", "cbs.scope_id")
																.append("foreignField", "_id").append("as", "project")),
												new Document().append("$unwind",
														new Document().append("path", "$project").append(
																"preserveNullAndEmptyArrays", true)),
												new Document().append("$addFields", new Document().append("project_id",
												...
												new Document().append("$group",
														new Document().append("_id", new Document().append("$substr",
																Arrays.asList("$id", 0.0, 4.0))).append(
																		"budget",
														...
														new Document().append("$subtract",
																Arrays.asList(new Document().append("$toInt", "$_id"),
																		new Document().append("$toInt",
																				"$$nowYear"))))),
												new Document().append("$addFields", new Document()
														.append("presentBudget", new Document().append("$cond",
																Arrays.asList(new Document()
																		.append("$gte",
																				Arrays.asList("$exponent", 0.0)),
																		new Document().append("$divide", Arrays.asList(
																				...
																				new Document().append("$pow", Arrays
																						.asList(new Document().append(
																								...
																								new Document().append(
																										...
																										"$exponent"))))),
																		new Document().append("$multiply",
																				Arrays.asList("$budget", new Document()
																						.append("$pow", Arrays.asList(
																								new Document().append(
																										"$add",
																										Arrays.asList(
				...
				new Document().append("$unwind", new Document().append("path",
						"$salesForecastMonthData").append("preserveNullAndEmptyArrays",
								true)),
				new Document().append("$lookup",
						new Document().append("from", "salesMonthData")
								.append("let",
										new Document().append("project_id", "$_id").append("discountRate",
												"$discountRate").append("nowYear", "$nowYear").append("sDate",
														"$sDate"))
								.append("pipeline", Arrays.asList(
										...
										new Document().append("$group", new Document().append("_id", null)
												...
												.append("profit", new Document().append("$sum", "$profit"))),
										new Document().append("$addFields",
												new Document().append("profitRate",
														new Document().append("$cond", Arrays.asList(
																new Document().append("$eq",
																		Arrays.asList(new Document().append("$ifNull",
																				Arrays.asList("$revenue", 0.0)), 0.0)),
				...
				new Document().append("$unwind", new Document().append("path", "$cbsMonthData").append(
						"preserveNullAndEmptyArrays", true)),
				new Document().append("$project", new Document().append("project_id", "$_id")
