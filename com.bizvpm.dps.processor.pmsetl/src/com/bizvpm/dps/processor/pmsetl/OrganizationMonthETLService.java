...
public class OrganizationMonthETLService extends AbstractMonthETLService {
	...
	private void createOrganizationMonthData(MongoCollection<Document> prjColl, MongoCollection<Document> oMDCol,
		...
		List<? extends Bson> pipeline = Arrays.asList(
				new Document("$graphLookup", new Document("from", "organization").append("startWith", "$_id")
						.append("connectFromField", "_id").append("connectToField", "parent_id")
						.append("as", "children").append("depthField", "level")),
				new Document("$addFields", new Document("children",
						new Document("$concatArrays", Arrays.asList("$children._id", Arrays.asList("$_id"))))),
				new Document("$lookup", new Document("from", "project")
						.append("let", new Document("impUnit_id", "$children"))
						.append("pipeline", Arrays.asList(new Document("$match",
								new Document("$expr", new Document("$and",
										Arrays.asList(
												new Document("$in", Arrays.asList("$impUnit_id", "$$impUnit_id"))))))))
						.append("as", "project_id")),
				new Document("$addFields", new Document("project_id", "$project_id._id")),
				new Document("$addFields", new Document("discountRate", discountRate).append("nowYear", year).append(
						"sDate", year + month)),
				new Document("$lookup", new Document("from", "salesforecast")
						...
						.append("pipeline", Arrays.asList(
								new Document("$match", new Document("$expr", new Document("$and", Arrays.asList(
										...
										new Document("$lte",
												Arrays.asList(
														new Document("$concat", Arrays.asList("$GJAHR", "$PERDE")),
														"$$sDate")))))),
								...
								new Document("$addFields", new Document("presentRevenue", new Document("$cond",
										Arrays.asList(new Document("$gte", Arrays.asList("$exponent", 0.0)),
												new Document("$divide",
														Arrays.asList("$revenue", new Document("$pow",
																Arrays.asList(
																		new Document("$add",
																				Arrays.asList(1.0, "$$discountRate")),
																		new Document("$abs", "$exponent"))))),
												new Document("$multiply",
														Arrays.asList("$revenue", new Document("$pow", Arrays.asList(
																new Document("$add",
																		Arrays.asList(1.0, "$$discountRate")),
																new Document("$abs", "$exponent")))))))).append(
																		...
																		new Document("$cond", Arrays.asList(
																				new Document("$gte",
																						Arrays.asList("$exponent",
																								0.0)),
																				new Document("$divide", Arrays.asList(
																						"$cost",
																						new Document("$pow", Arrays
																								.asList(new Document(
																										"$add",
																										Arrays.asList(
																												1.0,
								...
								new Document("$addFields",
										new Document("profitRate", new Document("$cond", Arrays.asList(
												new Document("$eq", Arrays.asList(
														new Document("$ifNull", Arrays.asList("$revenue", 0.0)), 0.0)),
												0.0, new Document("$divide", Arrays.asList("$profit", "$revenue")))))
				...
				new Document("$lookup", new Document("from", "cbsSubject")
						.append("let", new Document("project_id", "$project_id").append("discountRate", "$discountRate")
								.append("nowYear", "$nowYear"))
						.append("pipeline", Arrays.asList(
								new Document("$lookup", new Document("from", "cbs").append("localField", "cbsItem_id")
								...
								new Document("$match", new Document("$expr", new Document("$and",
										Arrays.asList(new Document("$in", Arrays.asList("$project_id", "$$project_id")),
												new Document())))),
								new Document("$group",
								...
								new Document("$addFields",
										new Document("exponent", new Document("$subtract",
												Arrays.asList(new Document("$toInt", "$_id"),
														new Document("$toInt", "$$nowYear"))))),
								new Document("$addFields", new Document("presentBudget", new Document("$cond",
										Arrays.asList(new Document("$gte", Arrays.asList("$exponent", 0.0)),
												new Document("$divide",
														Arrays.asList("$budget",
																new Document("$pow",
																		Arrays.asList(
																				...
																				new Document("$abs", "$exponent"))))),
												new Document("$multiply",
														Arrays.asList("$budget", new Document("$pow", Arrays.asList(
																new Document("$add",
																		Arrays.asList(1.0, "$$discountRate")),
																new Document("$abs", "$exponent")))))))).append(
																		"presentCost",
				...
				new Document("$unwind",
						new Document("path", "$salesRealityTotalData").append("preserveNullAndEmptyArrays", true)),
				new Document("$lookup", new Document("from", "cbsSubject")
						.append("let", new Document("project_id", "$project_id").append("discountRate", "$discountRate")
								.append("nowYear", "$nowYear"))
						.append("pipeline", Arrays.asList(
				...
				new Document("$unwind", new Document("path",
						"$cbsTotalData").append("preserveNullAndEmptyArrays",
								true)),
				new Document("$lookup",
						new Document("from",
								"salesforecast")
				...
				new Document("$unwind",
						new Document("path", "$salesForecastTotalData").append("preserveNullAndEmptyArrays", true)),
				new Document("$lookup", new Document("from", "salesforecast")
						.append("let",
								new Document("project_id", "$project_id").append("discountRate", "$discountRate")
										.append("nowYear", "$nowYear").append("sDate", "$sDate"))
				...
				new Document("$unwind",
						new Document("path", "$salesForecastMonthData").append("preserveNullAndEmptyArrays", true)),
				new Document("$lookup", new Document("from", "salesMonthData")
						.append("let",
								new Document("project_id", "$project_id").append("discountRate", "$discountRate")
										.append("nowYear", "$nowYear").append("sDate", "$sDate"))
				...
				new Document(
						"$unwind", new Document("path", "$salesRealityMonthData").append("preserveNullAndEmptyArrays",
								true)),
				...
				new Document("$addFields", new Document("forecastPP", new Document("$cond", Arrays.asList(
						new Document("$eq", Arrays.asList("$forecastYearAvgProfit", 0.0)), 0.0,
						new Document("$multiply", Arrays.asList(
								new Document("$divide", Arrays.asList("$budget", "$forecastYearAvgProfit")), 12.0)))))
										...
										.append("forecastPresentROI",
												new Document("$cond", Arrays.asList(
														new Document("$eq", Arrays.asList("$presentBudget", 0.0)), 0.0,
														new Document("$divide",
										...
										.append("realityPresentROI",
												new Document("$cond", Arrays.asList(
														new Document("$eq", Arrays.asList("$presentCost", 0.0)), 0.0,
														new Document("$divide",
										...
										.append("realityNPV", new Document("$add",
												Arrays.asList(
														new Document("$multiply", Arrays.asList(-1.0, "$presentCost")),
