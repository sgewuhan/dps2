...
public class EPSMonthETLService extends AbstractMonthETLService {
	...
	private void createEPSMonthData(MongoCollection<Document> prjColl, MongoCollection<Document> eMDCol,
		...
		List<Bson> pipeline = Arrays
				.asList(new Document("$graphLookup", new Document("from", "eps")
						.append("startWith", "$_id").append("connectFromField", "_id")
						.append("connectToField", "parent_id").append("as", "children").append("depthField", "level")),
						new Document("$addFields",
								new Document("children", new Document("$concatArrays",
										Arrays.asList("$children._id", Arrays.asList("$_id"))))),
						new Document("$lookup", new Document("from", "project")
								.append("let", new Document("eps_id", "$children")).append("pipeline",
										Arrays.asList(new Document("$match",
												new Document("$expr",
														new Document("$and", Arrays.asList(
																new Document("$project",
																		new Document("_id", true).append("eps_id",
																				true)),
																new Document("$in",
																		Arrays.asList("$eps_id", "$$eps_id"))))))))
								.append("as", "project_id")),
						new Document("$addFields", new Document("project_id", "$project_id._id")), new Document(
								"$addFields", new Document("discountRate", discountRate).append("nowYear", year).append(
										"sDate", year + month)),
						new Document("$lookup", new Document("from", "salesforecast").append("let",
								...
								.append("pipeline", Arrays.asList(
										new Document("$match",
												new Document("$expr", new Document("$and", Arrays.asList(new Document(
														"$in", Arrays.asList("$project_id", "$$project_id")))))),
										new Document("$group", new Document("_id", "$GJAHR")
												.append("revenue", new Document("$sum", "$VV010"))
												.append("cost", new Document("$sum", new Document("$add",
						...
						new Document("$lookup", new Document("from", "salesMonthData")
								.append("let", new Document("project_id", "$project_id")
										...
										.append("pipeline", Arrays.asList(
												...
												new Document("$project",
														new Document("id", true)
																...
																.append("cost", new Document("$ifNull",
												...
												new Document(
														"$group",
														new Document()
																.append("_id", new Document("$substr",
						...
						new Document("$lookup",
								new Document("from", "cbsSubject")
										...
										.append("pipeline", Arrays.asList(new Document("$lookup",
												new Document("from", "cbs").append("localField", "cbsItem_id").append(
														"foreignField", "_id").append("as",
																"cbs")),
												new Document("$unwind", "$cbs"),
												new Document("$graphLookup",
														new Document("from", "cbs").append("startWith", "$cbs._id")
												...
												new Document("$lookup",
														new Document("from", "project").append("localField",
																"cbs.scope_id").append("foreignField", "_id").append(
																		"as", "project")),
												new Document("$unwind",
														new Document("path", "$project")
																.append("preserveNullAndEmptyArrays", true)),
												new Document("$addFields", new Document("project_id",
														new Document("$ifNull",
																Arrays.asList("$work.project_id", "$project._id")))),
												new Document(
														"$lookup", new Document("from", "project")
						...
						new Document("$unwind", new Document("path", "$cbsTotalData").append(
								"preserveNullAndEmptyArrays", true)),
												...
												new Document("$addFields",
														new Document("exponent", new Document("$subtract",
																Arrays.asList(new Document("$toInt", "$_id"),
																		new Document("$toInt", "$$nowYear"))))),
												new Document("$addFields", new Document()
														.append("presentRevenue", new Document("$cond", Arrays.asList(
																new Document("$gte", Arrays.asList("$exponent", 0.0)),
																new Document("$divide", Arrays.asList("$revenue",
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																		...
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
																						Arrays.asList(1.0,
																								"$$discountRate")),
																				new Document("$abs", "$exponent"))))))))
														.append("presentProfit", new Document("$cond", Arrays.asList(
																new Document("$gte", Arrays.asList("$exponent", 0.0)),
																new Document("$divide", Arrays.asList("$profit",
																		new Document("$pow", Arrays.asList(
																				new Document("$add",
						...
						new Document("$unwind",
								new Document("path", "$salesForecastMonthData").append("preserveNullAndEmptyArrays",
										true)),
						new Document("$lookup", new Document("from", "salesMonthData").append("let",
								new Document("project_id", "$project_id").append("discountRate", "$discountRate")
						...
						new Document("$unwind", new Document(
								"path", "$salesRealityMonthData").append("preserveNullAndEmptyArrays", true)),
						new Document("$lookup",
								new Document("from", "cbsSubject")
										.append("let",
						...
						new Document("$unwind", new Document("path", "$cbsMonthData").append(
								"preserveNullAndEmptyArrays", true)),
						new Document("$project",
								new Document("eps_id", "$_id")
										...
										.append("forecastPresentProfitRate",
												new Document("$ifNull",
														Arrays.asList("$salesForecastTotalData.presentProfitRate",
																0.0)))
										.append("forecastMonthRevenue",
												new Document("$ifNull",
														Arrays.asList("$salesForecastMonthData.revenue", 0.0)))
										.append("forecastMonthCost",
												new Document("$ifNull",
														Arrays.asList("$salesForecastMonthData.cost", 0.0)))
										.append("forecastMonthProfit",
												new Document("$ifNull",
														Arrays.asList("$salesForecastMonthData.profit", 0.0)))
										...
										.append("realityRevenue",
												new Document("$ifNull",
														Arrays.asList("$salesRealityTotalData.revenue", 0.0)))
										.append("realityCost",
												new Document("$ifNull",
														Arrays.asList("$salesRealityTotalData.cost", 0.0)))
										.append("realityProfit",
												new Document(
														"$ifNull", Arrays.asList("$salesRealityTotalData.profit", 0.0)))
										...
										.append("realityMonthRevenue",
												new Document("$ifNull",
														Arrays.asList("$salesRealityMonthData.revenue", 0.0)))
										.append("realityMonthCost",
												new Document("$ifNull",
														Arrays.asList("$salesRealityMonthData.cost", 0.0)))
										.append("realityMonthProfit",
												new Document("$ifNull",
														Arrays.asList("$salesRealityMonthData.profit", 0.0)))
										.append("realitytMonthProfitRate",
												new Document("$ifNull",
														Arrays.asList("$salesRealityMonthData.profitRate", 0.0)))
										.append("budget",
												new Document("$ifNull", Arrays.asList("$cbsTotalData.budget", 0.0)))
										.append("cost",
												new Document("$ifNull", Arrays.asList("$cbsTotalData.cost", 0.0)))
										.append("presentBudget",
												new Document("$ifNull",
														Arrays.asList("$cbsTotalData.presentBudget", 0.0)))
										.append("presentCost",
												new Document("$ifNull",
														Arrays.asList("$cbsTotalData.presentCost", 0.0)))
										.append("monthBudget", new Document("$ifNull",
												Arrays.asList("$cbsMonthData.budget", 0.0)))
										.append("monthCost",
												new Document("$ifNull", Arrays.asList("$cbsMonthData.cost", 0.0)))
